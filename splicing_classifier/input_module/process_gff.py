...
# Currently, this module only contains the process_gff3 function.
# This function reads in a GFF3 file and returns the transcript, exon and
# intron information in dataframe format. Future iterations could extend
# this module to include functions to process other input file types.
